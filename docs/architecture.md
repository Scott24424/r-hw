...
> **이 표는 설계 단계의 초안이다. 실제 착수 기준은 `docs/specs/T##-*.md`다.**
> 2026-07-31 재분해에서 "태스크당 변경 파일 10개 이내" 제약을 적용해 **14개 → 19개**가 되었고 번호도 어긋난다.
> 구현 시 태스크 번호는 반드시 `docs/specs/`를 따를 것. 이 표는 T19에서 갱신한다.
